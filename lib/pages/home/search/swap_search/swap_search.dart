...
class SwapSearch extends StatefulWidget {
  @override
  _SwapSearchState createState() => _SwapSearchState();
}

class _SwapSearchState extends State<SwapSearch> {
                  ...
                  Expanded(
                    child: TextField(
                      decoration: InputDecoration(
                        hintText: "Domain name (link). Without http://www. ",
                        hintStyle: TextStyle(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Text(
                          'In turn you can run your Ad Set: ',
                          style: TextStyle(
                              color: Colors.black,
                              fontWeight: FontWeight.bold,
                              fontSize: 16.0),
